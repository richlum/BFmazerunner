...
void drawText(int x, int y, int point, char *str);
void drawPixel(int x, int y);
void drawLine(int x1, int y1, int x2, int y2, int width);
void drawTriangle(int x1, int y1, int x2, int y2, int x3, int y3, int width);
void drawRect(int x1, int y1, int w, int h, int width);
void drawOval(int x1, int y1, int w, int h, int width);
